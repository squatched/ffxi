...
**Boundary:** `data/` contains only game mechanics facts — what actions exist, when they unlock,
what they target. Nothing about how actions are grouped, prioritized, or arranged into macro sets
belongs here. That is configuration and lives in `macros/`.
...
two_hour_ability: Chainspell   # REQUIRED — not listed in abilities; all 2-hours are level 1 / <me>
